# Отчет по лидогенерации от 2026-07-15
...
|---|----------|---------|----------|-----------|---------|--------|
| 1 | ПК AKASHI Data Center PLC | Представитель компании | `hh.kz` | **10** | 🚫 | [Перейти](https://almaty.hh.kz/vacancy/135171273?query=%D0%B8%D0%B8&hhtmFrom=vacancy_search_list) |
