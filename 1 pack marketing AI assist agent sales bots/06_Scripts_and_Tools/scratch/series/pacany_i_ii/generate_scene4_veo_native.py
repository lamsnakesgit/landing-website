...
try:
    ...
    print(f"Ошибка initialization Vertex AI: {e}")
    sys.exit(1)
...
output_filename = "clip4_veo_native_audio.mp4"
...
print(f"Запуск генерации {output_filename} через veo-3.1-generate-001 с аудио...")
