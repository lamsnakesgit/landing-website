...
FILES = [
    "/Users/higherpower/Desktop/1_Active_Projects/AI_Marketing/концентрат 2д конец/web_ai_ledovskikh_vertical_ScreenRecording_10-18-2025 14-18-02_1.MP4"
]
...
def upload_video(file_path):
    ...
    metadata = {
        "snippet": {
            ...
            "tags": ["maton", "ai", "web_ai_ledovskikh_vertical", "nnsvt"],
            "categoryId": "22"
        },
        "status": {
